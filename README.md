...
tokens allow a users info to be stored securely and is used for authorization

2. What steps can you take in your web apps to keep your data secure?

privateRoutes/tokens

3. Describe how web servers work.

web servers take requests and check for credentials before sending info back to the user. it retrieves from your project code to users upon request.
